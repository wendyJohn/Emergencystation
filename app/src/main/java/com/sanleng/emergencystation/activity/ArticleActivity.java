...
public class ArticleActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new MyTask().execute(URLs.Article_URL + pageNo + "&pageSize=" + 50 + "&publicitytype=1"
                ...
                + PreferenceUtils.getString(ArticleActivity.this, "EmergencyStation_username"));
    ...
    private void loadData(String id, final String name, final String category, final String frequency) {
        ...
        params.put("ids", id);
        params.put("username", PreferenceUtils.getString(ArticleActivity.this, "EmergencyStation_username"));
