...
public class MaterialManagementActivity extends Activity implements OnClickListener, OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
		switch (position) {
			case 0:// 入库
				Intent intent_Warehousing = new Intent(MaterialManagementActivity.this, MaterialCaptureActivity.class);
				intent_Warehousing.putExtra("mode", "Warehousing");
				startActivity(intent_Warehousing);
				break;
			case 1:// 出库
				Intent intent_OutOfStock = new Intent(MaterialManagementActivity.this, MaterialCaptureActivity.class);
			...
			case 2:// 物资查询
				...
				break;
			case 3:// 报损
				Intent intent_Reportloss = new Intent(MaterialManagementActivity.this, MaterialCaptureActivity.class);
