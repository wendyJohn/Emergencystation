...
import  com.sanleng.emergencystation.zxing.activiry.CaptureActivityHandler;
import  com.sanleng.emergencystation.zxing.bean.ZxingConfig;
import  com.sanleng.emergencystation.zxing.camera.OpenCameraInterface;
...
public final class CameraManager {
    ...
    private com.sanleng.emergencystation.zxing.camera.AutoFocusManager autoFocusManager;
    ...
    public CameraManager(Context context, ZxingConfig config) {
        ...
        this.configManager = new com.sanleng.emergencystation.zxing.camera.CameraConfigurationManager(context);
...
//    }
    ...
    public synchronized void startPreview() {
        ...
        if (theCamera != null && !previewing) {
            ...
            previewing = true;
            autoFocusManager = new com.sanleng.emergencystation.zxing.camera.AutoFocusManager(camera);
        }
    }
